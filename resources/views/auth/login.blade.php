            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-sm-5 text-right"><a href="{{route('auth.magic.login.form')}}"><small>@lang('auth.magic login')</small></a></div>
                    </div>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('auth.login') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-check">
                                <a href="{{ route('auth.password.forgot.form') }}"><small>@lang('auth.forget your password')</small></a>
                            </div>
                        </div>
                        <div class="offset-sm-3">
                        ...
                        <a href="{{ route('auth.login.provider.redirect','google') }}"
                           class="btn btn-danger">@lang('auth.login by google')</a>
                    </form>
                </div>
            </div>
        </div>
